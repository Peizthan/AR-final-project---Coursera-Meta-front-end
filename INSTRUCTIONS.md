...
This project is hosted on GitHub and can be run locally by following the steps below.
...
```bash
git clone https://github.com/Peizthan/AR-final-project---Coursera-Meta-front-end.git
```

### 2. Navigate to the Project Directory

```bash
cd AR-final-project---Coursera-Meta-front-end
```
...
This will install Chakra UI, Formik, Yup, and all other required packages listed in `package.json`.
...
The app will open automatically in your browser at `http://localhost:3000`. You should see a page with an empty header, three full-height sections, and a footer.
